<div class="inline" x-data="{ open: 0, date: 'Anytime' }">
    ...
    <div x-show="open" x-cloak
        class="fixed top-0 left-0 flex items-center justify-center w-screen h-screen pt-20 bg-primary/10">

        <div x-show="open" x-on:click.away="open=0" x-transition class="pt-20">

            <div class="mx-5 -translate-y-[40%] bg-gray-0 rounded-xl">
                ...
                <div
                    ...
                    <div class="flex flex-col h-full">
                        ...
                        <div wire:click="date('any')" x-on:click="open=0;date='Anytime'"
                            class="px-5 py-4 font-medium text-center transition-all border-b cursor-pointer hover:bg-gray-1 last:border-0 border-gray-1">
                            Anytime
                        </div>
