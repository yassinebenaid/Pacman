<div class="flex items-center text-2xl font-bold after:w-20 after:h-20 after:bg-red-100 after:contents after:p-5">
    <svg class="text-primary" width="50" height="50" viewBox="0 0 24 24" fill="none"
    ...
    <div class="hidden xl:inline"> Pac<span class="text-primary">man</span> </div>
</div>
